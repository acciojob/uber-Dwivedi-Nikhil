...
//		return tripBooking;
		...
		TripBooking tripBooking = new TripBooking(); // creating new trip
		Driver driver =null;
		...
		for (Driver driver1 : driverList){
			...
			//finding if driver is available or not
		...
		//set bidirectional-
	//	customer.getTripBookingList().add(tripBooking);  //null pointer
		...
		//driver.getTripBookingList().add(tripBooking); //null
